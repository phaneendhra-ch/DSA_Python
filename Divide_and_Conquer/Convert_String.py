"""
    ...
    Convert a string to another using delete,add and replace operations
...
def convert_string(index1,index2,string1,string2):
    ...
    if (string1[index1] == string2[index2]):        #if we are at same characters( then increment index value of both string1 and string2 by 1)
        return convert_string(index1+1 ,index2+1 ,string1,string2)

    else:
        delete_operation = 1 + convert_string(index1 ,index2+1 ,string1,string2)        # for delete then move S2 index to next one
        insert_operation = 1 + convert_string(index1+1 ,index2 ,string1,string2)        # for add then move S1 index to next one
        replace_operation = 1 + convert_string(index1+1 ,index2+1 ,string1,string2)     # for replace then move S1 and S2 index to next one
